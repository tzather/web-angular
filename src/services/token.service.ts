...
export class TokenService {
  ...
  public displayGauge = () => this._payload.displayGauge ?? false;

  public displayBarChart = () => this._payload.displayBarChart ?? false;

  public displayPieChart = () => this._payload.displayBarChart ?? false;

  public displayLineChart = () => this._payload.displayBarChart ?? false;
}
